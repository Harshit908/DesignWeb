  ...
  <section class="why" id="why">
    <div class="max-wit">
      ...
      <div class="why-content">
        ...
        <div class="image">
          <h3>Contemporary Style Bathroom</h3>
          <img src="../assets/images/n1.jpg" alt="">
          </div>

          <div class="image">
              <h3>Eclectic Style Bathroom</h3>
            <img src="../assets/images/n2.jpg" alt="">
            </div>

          <div class="image">
            <h3>Modern Style Bathroom</h3>
            <img src="../assets/images/n3.jpg" alt="">
            </div>


            <div class="image">
              <h3>Traditional Style Bathroom</h3>
              <img src="../assets/images/n4.jpg" alt="">
                ...
                <div class="image">
                  <h3>Asian Style Bathroom</h3>
                  <img src="../assets/images/n5.jpg" alt="">
                  </div>

                  <div class="image">
                    <h3>Beach Style Bathroom</h3>
                    <img src="../assets/images/n6.jpg" alt="">
                    </div>

                    <div class="image">
                      <h3>Craftsman-Style Bathroom</h3>
                      <img src="../assets/images/n7.jpg" alt="">
                      </div>

                      <div class="image">
                        <h3>Farmhouse Style Bathroom</h3>
                        <img src="../assets/images/n8.jpg" alt="">
                        </div>

                        <div class="image">
                          <h3>Industrial Style Bathroom</h3>
                          <img src="../assets/images/n9.jpg" alt="">
                          </div>
